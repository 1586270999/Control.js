...
; !function () {
    ...
    Class.prototype.view = function () {
        ...
        , views = {
          ...
          , limit: function () {
              ...
              layeach(config.limits, function (index, item) {
                  options.push(
                    '<option value="' + item + '"'
        ...
        return ['<div class="layui-box layui-laypage layui-laypage-' + (config.theme ? (
          ...
          , function () {
              var plate = [];
              layeach(config.layout, function (index, item) {
                  if (views[item]) {
    ...
    var laypage = {
      ...
      , index: window.JointLayPage ? (window.JointLayPage.index + 10000) : 0
