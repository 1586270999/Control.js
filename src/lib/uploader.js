...
; !function () {
    ...
    Class.prototype.config = {
        ...
        , url: '/DataHandler/DoAsynSaveUploaderFile.ashx' //上传地址
        , field: 'file' //文件字段名
    ...
    Class.prototype.initIE = function () {
        ...
        if (!options.elem.next().hasClass(ELEM_FORM)) {
            ...
            options.elem.next('.' + ELEM_FORM).append(function () {
                var arr = [];
                layeach(options.data, function (key, value) {
    ...
    Class.prototype.preview = function (callback) {
        ...
        if (window.FileReader) {
            layeach(that.chooseFiles, function (index, file) {
    ...
    Class.prototype.upload = function (files, type) {
        var that = this
            ...
            , ajaxSend = function () {
                ...
                layeach(items, function (index, file) {
            ...
            , check, value = function () {
                var arr = [];
                layeach(files || that.chooseFiles, function (i, item) {
                    arr.push(item.name);
                });
                return arr;
            }()
            ...
            , args = {
                ...
                , pushFile: function () {
                    ...
                    layeach(that.chooseFiles, function (index, item) {
    ...
    (
        (typeof define === 'function' && define.amd) ? define(function () { //requirejs加载
            ...
            if(CheckIsNullOrEmpty(window.JointFileUpload)){
                window.JointFileUpload = upload
            }
            else{
                window.JointFileUpload = $.extend(window.JointFileUpload, upload);
            }
        }()
    );
}();
